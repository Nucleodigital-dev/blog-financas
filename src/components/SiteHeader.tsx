    ...
    <header className="header">
      <div className="container header-content">
        <Link href="/" className="logo" onClick={closeMenu}>
          <span className="logo-badge logo-dark-only">
            <Image src="/logo-dark.png" alt={logoAlt} width={160} height={54} style={{ objectFit: "contain" }} priority />
          </span>
          <span className="logo-badge logo-light-only">
            <Image src="/logo-light.png" alt={logoAlt} width={160} height={54} style={{ objectFit: "contain" }} priority />
          </span>
        </Link>
