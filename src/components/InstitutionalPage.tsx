...
export function InstitutionalPage({
  ...
  return (
    <article style={{ maxWidth: 920, margin: "0 auto", padding: "24px 0 64px" }}>
      ...
      <h1 style={{ fontSize: "3rem", marginBottom: 20, fontFamily: "var(--font-heading)" }}>{title}</h1>
      ...
      <div style={{ display: "grid", gap: 20 }}>
        {sections.map((section) => (
          ...
          >
            <h2 style={{ fontSize: "1.55rem", marginBottom: 12, fontFamily: "var(--font-heading)" }}>{section.title}</h2>
